...
dat = SnpData("/shared/ukbiobank_filtered/filtered_200k")
pheno = CSV.read("/shared/ukbiobank_filtered/ukb_short.filtered.200k.tab"; delim="\t")
...
t = convert(A{T}, pheno[1:m, :AgeAtOnset])
